    ...
    <div className="space-y-6">
      <header>
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-gray-900">操作日志</h2>
        </div>
        <p className="text-gray-500">详细记录系统中所有關鍵操作的版本歷史</p>
      </header>
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center">
        ...
        <div className="flex items-center gap-2">
          <button onClick={fetchLogs} className="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">
            刷新
          </button>
        </div>
      </div>
