    ...
    <div className="space-y-6">
      <header className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">查看所属项目的全部财务往来记录</p>
        </div>
      </header>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
          ...
          <p className="text-sm font-medium text-gray-500">累计项目收入</p>
        ...
        <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
          ...
          <p className="text-sm font-medium text-gray-500">累计项目成本</p>
          <p className="text-2xl font-black text-gray-900 mt-1">{formatCurrency(totalExpense)}</p>
        </div>

        <div className="rounded-3xl bg-indigo-600 p-6 shadow-lg shadow-indigo-200">
          <div className="mb-4 flex items-center justify-between">
            <div className="rounded-2xl bg-white/20 p-3 text-white">
              <Briefcase className="h-6 w-6" />
            </div>
          </div>
          <p className="text-sm font-medium text-indigo-100">项目盈余</p>
