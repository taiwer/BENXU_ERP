    ...
    <div className="space-y-6">
      <header className="flex items-center gap-3 md:gap-4">
        ...
        <div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="rounded-full bg-blue-50 px-2 py-0.5 text-[8px] md:text-[10px] font-bold text-blue-600 uppercase">
              往来详情
            </span>
          </div>
          <p className="text-xs md:text-sm text-gray-500">查看与该对象的所有交易记录</p>
        </div>
      </header>
      ...
      <div className="grid gap-4 md:gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-2xl md:rounded-3xl border border-gray-100 bg-white p-4 md:p-6 shadow-sm">
          ...
          <p className="text-xs md:text-sm font-medium text-gray-500">累计收益</p>
        ...
        <div className="rounded-2xl md:rounded-3xl border border-gray-100 bg-white p-4 md:p-6 shadow-sm">
          ...
          <p className="text-xs md:text-sm font-medium text-gray-500">累计支出</p>
          <p className="text-xl md:text-2xl font-black text-gray-900 mt-1">{formatCurrency(totalExpense)}</p>
        </div>

        <div className="rounded-2xl md:rounded-3xl bg-blue-600 p-4 md:p-6 shadow-lg shadow-blue-200">
          <div className="mb-3 md:mb-4 flex items-center justify-between">
            <div className="rounded-xl md:rounded-2xl bg-white/20 p-2 md:p-3 text-white">
              <Users className="h-5 w-5 md:h-6 md:w-6" />
            </div>
          </div>
          <p className="text-xs md:text-sm font-medium text-blue-100">净收益</p>
            ...
            <div key={record.id} className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm active:bg-gray-50">
              <div className="flex items-start justify-between mb-2">
                <div>
                  ...
                  <div className="mt-0.5 text-sm font-bold text-gray-900 line-clamp-1">
